      ...
      <div ref={ref} className={`${always ? "relative" : "sm:hidden relative"}`}>
        ...
        {open && (
          <div
            ...
            className="fixed sm:absolute left-3 right-3 sm:left-auto sm:right-0 bottom-[calc(5rem+env(safe-area-inset-bottom))] sm:bottom-auto sm:top-full sm:mt-1 z-[45] pane glass p-2 sm:min-w-[220px] max-h-[60vh] overflow-y-auto flex flex-col gap-1 shadow-2xl"
          >
            {children}
          </div>
        )}
